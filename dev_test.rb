...
begin
		client.query("CREATE TABLE hle_dev_test_thiago_duarte 
		...
		alter = <<~SQL
  	ALTER TABLE hle_dev_test_thiago_duarte 
  	...
  	insertion = <<~SQL
  	insert IGNORE INTO hle_dev_test_thiago_duarte (candidate_office_name) 
  ...
  select id, candidate_office_name FROM hle_dev_test_thiago_duarte 
  ...
  SQL
	...
	puts "Nothing to update"
     ...
     update = "UPDATE hle_dev_test_thiago_duarte"\
